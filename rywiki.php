<?php // RuoyuWiki by LionWiki 3.2.11, ©zhaoyang2004, licensed under GNU/GPL v2 
foreach($_REQUEST as $k => $v)
	unset($$k); // register_globals = off

// SETTINGS - default settings, can be overridden in config.php
$WIKI_TITLE = '若愚Wiki-协同创作！'; // name of the site
$PASSWORD = ''; // SHA1 hash
...
$T_SYNTAX = '排版帮助';
$T_DONE = '保存';
$T_DISCARD_CHANGES = '放弃编辑';
$T_PREVIEW = '预览';
$T_SEARCH = '搜索';
$T_SEARCH_RESULTS = '搜索结果';
$T_LIST_OF_ALL_PAGES = '页面列表';
$T_RECENT_CHANGES = '条目列表';
$T_LAST_CHANGED = '最后编辑';
$T_HISTORY = '编辑历史';
$T_RESTORE = '恢复';
$T_REV_DIFF = '<b>修订之间的差异： {REVISION1} 和 {REVISION2}.</b>';
$T_REVISION = "'''这个版本来自 {TIME}. 你可以 {RESTORE} it.'''\n\n";
$T_PASSWORD = '密码保护';
$T_EDIT = '点我编辑';
$T_EDIT_SUMMARY = '变更摘要';
$T_EDIT_CONFLICT = '编辑冲突：有人在您开始编辑后保存了此页。见最后一页{DIFF} (在你保存编辑之前)';
$T_SHOW_SOURCE = '显示源';
$T_SHOW_PAGE = '显示页面';
$T_ERASE_COOKIE = '删除历史';
$T_MOVE_TEXT = '新页面名';
$T_DIFF = '差异';
$T_CREATE_PAGE = '创建页面';
$T_PROTECTED_READ = '您需要输入密码才能查看网站内容： ';
